...
namespace MyEshop.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Payment()
        {
            ...
            var payment = new Payment(order.OrderDetails.Sum(p=>p.Price));
            var res = payment.PaymentRequest($"پرداخت فاکتور شماره {order.OrderId}", "http://localhost:59662/Home/OnlinePayment/" + order.OrderId, "aghaei.mhr@gmail.com", "09195304005");
